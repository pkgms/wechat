 ...
 * @returns {Promise<*>}
 */
wp.httpReq = async ( obj, security = true ) => {
 ...
 * @returns {Promise<void>}
 */
wp.refreshToken = async refreshToken => {
 ...
 * @returns {Promise<void>}
 */
wp.auth = async ( accessToken, openId ) => {
 ...
 * @returns {Promise<void>}
 */
wp.getUserInfo = async ( accessToken, openId ) => {
